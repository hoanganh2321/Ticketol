          ...
          try {
            ...
            if (ticketChannel) {
              const fixedTicketEmbed = new EmbedBuilder()
                .setColor('#0099ff')
                .setTitle('🎟️ Welcome to Kaioshin Ticket')
                .setImage('https://cdn.discordapp.com/attachments/1090895809098289185/1232707617436991499/hinh-anh-chill.jpg?ex=662d12ee&is=662bc16e&hm=124d3bfc252d4e38a492d62f8decc3d8f347717aeefc94748185ec66ae5c8f8d&')
              .setDescription('Cảm Ơn Bạn Đã Sử Dụng Dịch Vụ, Ấn Nút Ở Dưới Để Tạo Ticket.\n\n' +
                 '**Ticket Guidelines:**\n' +
                 '- Vui Lòng Không Tạo Ticket Để Chơi, Để Nghịch.\n' +
                 '- Tạo Ticket Xong Thì Chờ 1 Xíu Nhé ! .')
              .setFooter({ text: 'Code by Kaioshin | Miao ', iconURL:'https://cdn.discordapp.com/attachments/1090895809098289185/1233048077557039185/1345658.png?ex=662cfe82&is=662bad02&hm=2cd9f3aa1e64083129736e3c07bb7ddea6f951e640d2e58755162c53054f4cbf&'});
